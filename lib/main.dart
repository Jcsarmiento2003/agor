...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Simple Quiz',
      theme: ThemeData(primarySwatch: Colors.red, scaffoldBackgroundColor: Colors.grey),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      'question': 'Which feature would help a coffee shop improve customer experience?:',
      'answers': [
    ...
    {
      'question': 'Which feature would help a coffee shop streamline operations?:',
      'answers': [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.red, title: Text('Coffee Shop Quiz')),
      body: Center(
        child: quizStarted
        ...
        children: [
          ...
          ...List.generate(4, (index) {
            ...
            return Padding(
              ...
              child: ElevatedButton(
                onPressed: answered ? null : () => answerQuestion(index), // Disable after answering
                style: ElevatedButton.styleFrom(
                  backgroundColor: buttonColor, // Flash color based on answer correctness
          ...
          if (answered)
            ElevatedButton(
              ...
              child: Text(
                currentQuestionIndex < questions.length - 1 ? 'Next' : 'End Quiz',
              ),
            ),
        ],
      ),
